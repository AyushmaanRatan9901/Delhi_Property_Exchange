  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? colors.background : "#F8FAFC" }]}>
      ...
      >
        ...
        <Text style={styles.headerSubtitle}>On-site room checks, geo-tagging & photo audits</Text>
      </LinearGradient>
      ...
      >
        ...
        <View style={[styles.card, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
          <View style={styles.cardHeader}>
            ...
            <Text style={[styles.cardTitle, { color: colors.textPrimary }]}>Inspections Management</Text>
          </View>

          <Text style={[styles.cardDesc, { color: colors.textSecondary }]}>
            Welcome to the Verification Staff Inspections portal. Manage and monitor real-time records, activities, and operational workflows directly from this screen.
          </Text>
