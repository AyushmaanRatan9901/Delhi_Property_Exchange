  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? colors.background : "#F8FAFC" }]}>
      ...
      >
        ...
        <Text style={styles.headerSubtitle}>Properties awaiting document verification & physical visit</Text>
      </LinearGradient>
      ...
      >
        ...
        <View style={styles.statsRow}>
          ...
          <View style={[styles.statCard, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
            ...
            <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Standard</Text>
          </View>
          <View style={[styles.statCard, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
            <Text style={[styles.statValue, { color: colors.primary }]}>0</Text>
            <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Escalated</Text>
          </View>
        </View>
        ...
        <View style={[styles.card, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
          <View style={styles.cardHeader}>
            ...
            <Text style={[styles.cardTitle, { color: colors.textPrimary }]}>Pending Management</Text>
          </View>

          <Text style={[styles.cardDesc, { color: colors.textSecondary }]}>
            Welcome to the Verification Staff Pending portal. Manage and monitor real-time records, activities, and operational workflows directly from this screen.
          </Text>
          ...
          >
            <Text style={styles.primaryBtnText}>Review Pending</Text>
