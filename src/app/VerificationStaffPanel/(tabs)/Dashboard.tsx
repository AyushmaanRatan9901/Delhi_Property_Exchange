  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? colors.background : "#F8FAFC" }]}>
      ...
      >
        ...
        <Text style={styles.headerSubtitle}>Listing verification queue, physical inspection assignments</Text>
      </LinearGradient>
      ...
      >
        ...
        <View style={styles.statsRow}>
          ...
          <View style={[styles.statCard, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
            <Text style={[styles.statValue, { color: colors.primary }]}>35m</Text>
        ...
        <View style={[styles.card, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
          ...
          <Text style={[styles.cardDesc, { color: colors.textSecondary }]}>
            Welcome to the Verification Staff Dashboard portal. Manage and monitor real-time records, activities, and operational workflows directly from this screen.
          </Text>
          ...
          >
            <Text style={styles.primaryBtnText}>Start Verifications</Text>
