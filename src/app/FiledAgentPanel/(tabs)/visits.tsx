  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? colors.background : "#F8FAFC" }]}>
      ...
      >
        ...
        <Text style={styles.headerSubtitle}>Scheduled tenant viewings and site inspections</Text>
      </LinearGradient>
      ...
      >
        ...
        <View style={styles.statsRow}>
          ...
          <View style={[styles.statCard, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
            <Text style={[styles.statValue, { color: colors.primary }]}>32</Text>
            <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Past</Text>
          </View>
        </View>
        ...
        <View style={[styles.card, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
          <View style={styles.cardHeader}>
            ...
            <Text style={[styles.cardTitle, { color: colors.textPrimary }]}>Visits Management</Text>
          </View>

          <Text style={[styles.cardDesc, { color: colors.textSecondary }]}>
            Welcome to the Field Agent Visits portal. Manage and monitor real-time records, activities, and operational workflows directly from this screen.
          </Text>
