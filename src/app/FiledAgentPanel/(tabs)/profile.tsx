    ...
    >
      ...
      >
        ...
        <Text style={styles.headerSubtitle}>
          Agent verification badge, performance metrics & settings
        </Text>
      </LinearGradient>
      ...
      >
        ...
        >
          ...
          <Text style={[styles.cardDesc, { color: colors.textSecondary }]}>
            Welcome to the Field Agent Profile portal. Manage and monitor
            real-time records, activities, and operational workflows directly
            from this screen.
          </Text>
        ...
        >
          ...
          <Text style={[styles.noticeText, { color: colors.textMuted }]}>
            All updates on this screen sync in real-time with the Delhi Property
            Exchange backend engine.
          </Text>
        </View>
      </ScrollView>
    </View>
