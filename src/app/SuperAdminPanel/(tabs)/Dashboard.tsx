  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? colors.background : "#F8FAFC" }]}>
      ...
      >
        ...
        <Text style={styles.headerSubtitle}>System overview, total revenue & operational velocity</Text>
      </LinearGradient>
      ...
      >
        ...
        <View style={styles.statsRow}>
          ...
          <View style={[styles.statCard, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
            <Text style={[styles.statValue, { color: colors.primary }]}>₹4.8L</Text>
        ...
        <View style={[styles.card, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
          ...
          <Text style={[styles.cardDesc, { color: colors.textSecondary }]}>
            Welcome to the Super Admin Dashboard portal. Manage and monitor real-time records, activities, and operational workflows directly from this screen.
          </Text>
          ...
          >
            <Text style={styles.primaryBtnText}>System Overview</Text>
