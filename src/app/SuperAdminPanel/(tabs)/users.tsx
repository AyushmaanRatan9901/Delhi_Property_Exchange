  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? colors.background : "#F8FAFC" }]}>
      ...
      >
        ...
        <Text style={styles.headerSubtitle}>Manage Brokers, Owners, Field Agents, Staff & Tenants</Text>
      </LinearGradient>
      ...
      >
        ...
        <View style={styles.statsRow}>
          <View style={[styles.statCard, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
            <Text style={[styles.statValue, { color: colors.primary }]}>38</Text>
          ...
          <View style={[styles.statCard, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
            ...
            <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Brokers</Text>
          </View>
          <View style={[styles.statCard, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
            <Text style={[styles.statValue, { color: colors.primary }]}>180</Text>
            <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Owners</Text>
          </View>
        </View>
        ...
        <View style={[styles.card, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
          <View style={styles.cardHeader}>
            ...
            <Text style={[styles.cardTitle, { color: colors.textPrimary }]}>Users Management</Text>
          </View>

          <Text style={[styles.cardDesc, { color: colors.textSecondary }]}>
            Welcome to the Super Admin Users portal. Manage and monitor real-time records, activities, and operational workflows directly from this screen.
          </Text>
