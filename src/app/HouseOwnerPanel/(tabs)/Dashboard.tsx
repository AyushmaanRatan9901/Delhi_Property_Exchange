  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? colors.background : "#F8FAFC" }]}>
      ...
      >
        ...
        <Text style={styles.headerSubtitle}>Rental income, room occupancy & tenant requests</Text>
      </LinearGradient>
      ...
      >
        ...
        <View style={styles.statsRow}>
          ...
          <View style={[styles.statCard, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
            <Text style={[styles.statValue, { color: colors.primary }]}>₹58,000</Text>
        ...
        <View style={[styles.card, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
          ...
          <Text style={[styles.cardDesc, { color: colors.textSecondary }]}>
            Welcome to the House Owner Dashboard portal. Manage and monitor real-time records, activities, and operational workflows directly from this screen.
          </Text>
