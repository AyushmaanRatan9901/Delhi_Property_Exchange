    ...
    <View style={[styles.container, { backgroundColor: isDark ? colors.background : "#F8FAFC" }]}>
      ...
      >
        <View style={styles.headerTop}>
          <View>
            <Text style={styles.panelBadge}>ADMIN PARTNER</Text>
        ...
        <Text style={styles.headerSubtitle}>Franchise territory metrics, total inventory & regional revenue</Text>
      </LinearGradient>
      ...
      >
        ...
        <View style={styles.statsRow}>
          <View style={[styles.statCard, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
            ...
            <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Territory Units</Text>
          </View>
          <View style={[styles.statCard, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
            <Text style={[styles.statValue, { color: colors.primary }]}>45</Text>
            <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Active Leads</Text>
          </View>
          <View style={[styles.statCard, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
            <Text style={[styles.statValue, { color: colors.primary }]}>₹1.85L</Text>
            <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Monthly Rev</Text>
          </View>
        </View>
        ...
        <View style={[styles.card, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
          <View style={styles.cardHeader}>
            <View style={[styles.iconBox, { backgroundColor: isDark ? "rgba(13, 148, 136, 0.2)" : "#CCFBF1" }]}>
              <Ionicons name="grid" size={20} color="#0D9488" />
            </View>
            <Text style={[styles.cardTitle, { color: colors.textPrimary }]}>Dashboard Management</Text>
          </View>

          <Text style={[styles.cardDesc, { color: colors.textSecondary }]}>
            Welcome to the Admin Partner Dashboard portal. Manage and monitor real-time records, activities, and operational workflows directly from this screen.
          </Text>
          ...
          >
            <Text style={styles.primaryBtnText}>Territory Dashboard</Text>
