  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? colors.background : "#F8FAFC" }]}>
      ...
      >
        ...
        <Text style={styles.headerSubtitle}>All regional PGs, flats & co-living inventory</Text>
      </LinearGradient>
      ...
      >
        ...
        <View style={styles.statsRow}>
          <View style={[styles.statCard, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
            <Text style={[styles.statValue, { color: colors.primary }]}>88</Text>
            <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Total Inventory</Text>
          </View>
          <View style={[styles.statCard, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
            <Text style={[styles.statValue, { color: colors.primary }]}>76</Text>
        ...
        <View style={[styles.card, { backgroundColor: isDark ? colors.cardBackground : "#FFFFFF", borderColor: colors.border }]}>
          <View style={styles.cardHeader}>
            ...
            <Text style={[styles.cardTitle, { color: colors.textPrimary }]}>Listings Management</Text>
          </View>

          <Text style={[styles.cardDesc, { color: colors.textSecondary }]}>
            Welcome to the Admin Partner Listings portal. Manage and monitor real-time records, activities, and operational workflows directly from this screen.
          </Text>
          ...
          >
            <Text style={styles.primaryBtnText}>Manage Inventory</Text>
