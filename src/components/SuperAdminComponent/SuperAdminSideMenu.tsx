...
export const SuperAdminSideMenu: React.FC<SuperAdminSideMenuProps> = ({
  ...
  const CORE_MODULES: MenuItem[] = [
    ...
    },
    {
      ...
      subtitle: "Track leases, rent timeline & unit ledger",
      icon: "account-cash",
      iconType: "community",
      iconColor: "#059669",
      badge: "Rent Tracker",
    ...
    {
      id: "notification_automations",
      route: "/SuperAdminPanel/notification-automations",
      title: "Notification Automation",
      subtitle: "Rent reminders, overdue alerts & SLA triggers",
      icon: "robot",
      iconType: "community",
      iconColor: "#6366F1",
      badge: "Auto-Pilot",
