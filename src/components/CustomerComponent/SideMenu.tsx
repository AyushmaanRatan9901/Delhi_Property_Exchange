        ...
        >
          ...
          <LinearGradient
            ...
            style={[
              ...
              {
                paddingTop: Platform.OS === 'ios' ? spacing.xxl + 16 : spacing.xxl + 6,
          ...
          >
            ...
            <View style={[layout.horizontalView, { marginTop: spacing.sm }]}>
              ...
              <View style={{ marginLeft: spacing.md, flex: 1 }}>
                <View style={layout.horizontalView}>
                  <Text numberOfLines={1} style={[styles.userName, { fontSize: moderateScale(16.5) }]}>
                    Rahul Sharma
                  </Text>
                  <MaterialIcons name="verified" size={moderateScale(17)} color="#FDE047" style={{ marginLeft: 4 }} />
                </View>
                <Text style={[styles.userPhone, { fontSize: moderateScale(11.5) }]}>
                  +91 98765 43210
                </Text>
                <View
                  style={[
                ...
                >
                  <Text style={styles.verifiedTagText}>★ Pro Verified Tenant</Text>
                </View>
              </View>
            </View>
            ...
            >
              <View style={layout.horizontalViewBetween}>
                <View style={layout.horizontalView}>
                  <MaterialCommunityIcons name="star-circle" size={moderateScale(20)} color="#FDE047" style={{ marginRight: 6 }} />
                  <View>
                    <Text style={[styles.walletBalance, { fontSize: moderateScale(12) }]}>
                      StayCoins: <Text style={{ fontWeight: '800', color: '#FDE047' }}>1,500</Text>
                    </Text>
                    <Text style={[styles.walletSub, { fontSize: moderateScale(9.5) }]}>
                ...
                >
                  <Text style={[styles.redeemText, { fontSize: moderateScale(11), color: colors.primaryDark }]}>
                    Redeem
                  </Text>
                </TouchableOpacity>
              </View>
          ...
          {/* Segmented Mode Switcher (Tenant vs Owner/Broker) */}
          <View
            style={[
              styles.modeSegmentContainer,
              {
                backgroundColor: isDark ? colors.cardBackground : colors.surfaceLight,
                padding: spacing.xs,
            ...
            <View style={layout.horizontalView}>
              <TouchableOpacity
                ...
                style={[
                  ...
                  {
                    backgroundColor: userRole === 'tenant' ? (isDark ? colors.surfaceHover : colors.white) : 'transparent',
                    borderRadius: radii.lg,
                    paddingVertical: spacing.xs + 2,
                  },
                  userRole === 'tenant' && shadows.sm,
                ]}
              >
                <MaterialCommunityIcons
                  name="account-search"
                  size={moderateScale(15)}
                  color={userRole === 'tenant' ? colors.primary : colors.textMuted}
                  style={{ marginRight: 4 }}
                />
                <Text
                  style={{
                    fontSize: moderateScale(11.5),
                    fontWeight: userRole === 'tenant' ? '700' : '500',
                    color: userRole === 'tenant' ? colors.primary : colors.textSecondary,
                  }}
                >
                  Looking for Stay
                </Text>
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.segmentButton,
                  {
                    backgroundColor: userRole === 'owner' ? (isDark ? colors.surfaceHover : colors.white) : 'transparent',
                    borderRadius: radii.lg,
                    paddingVertical: spacing.xs + 2,
                  },
                  userRole === 'owner' && shadows.sm,
                ]}
              >
                <MaterialCommunityIcons
                  name="home-plus"
                  size={moderateScale(15)}
                  color={userRole === 'owner' ? colors.primary : colors.textMuted}
                  style={{ marginRight: 4 }}
                />
                <Text
                  style={{
                    fontSize: moderateScale(11.5),
                    fontWeight: userRole === 'owner' ? '700' : '500',
                    color: userRole === 'owner' ? colors.primary : colors.textSecondary,
                  }}
                >
                  List Property
                </Text>
          ...
          <ScrollView
            ...
            contentContainerStyle={[styles.menuContent, { paddingHorizontal: spacing.md, paddingBottom: spacing.xxl + 20 }]}
          >
            {/* Section 1: Main Services */}
            <Text style={[styles.sectionHeading, { fontSize: moderateScale(10.5), color: colors.textMuted, marginTop: spacing.md, marginBottom: spacing.xs }]}>
              CORE SERVICES
            </Text>
            <View
              style={[
                  ...
                  >
                    <View style={layout.horizontalView}>
                      ...
                      <View>
                        ...
                        {item.subtitle && (
                          <Text style={[typography.cardAmenity, { fontSize: moderateScale(10.5), color: colors.textSecondary, marginTop: 1 }]}>
                            {item.subtitle}
                          </Text>
                        )}
                      </View>
                    ...
                    {item.badge ? (
                      ...
                      >
                        <Text style={{ fontSize: moderateScale(10), fontWeight: '700', color: item.badgeColor }}>
                          {item.badge}
                        </Text>
                      </View>
                    ) : (
                      <Feather name="chevron-right" size={moderateScale(16)} color={colors.textMuted} />
                    )}
                  </TouchableOpacity>
                );
              })}
            ...
            >
              <View style={[layout.horizontalViewBetween, { marginBottom: spacing.sm }]}>
                ...
                <Text style={{ fontSize: moderateScale(11), color: colors.textSecondary, textTransform: 'capitalize' }}>
                  {themeMode} Mode
                </Text>
              </View>

              {/* 3 Pills: Light / Dark / System */}
              <View style={[layout.horizontalViewBetween, styles.themePillsContainer, { backgroundColor: isDark ? colors.surfaceHover : colors.surfaceLight, borderRadius: radii.pill, padding: 3 }]}>
            ...
            <TouchableOpacity
              activeOpacity={0.8}
              onPress={() => handleItemPress({ id: 'logout', icon: 'log-out', iconType: 'feather', title: 'Log Out', iconColor: '#EF4444', iconBgLight: '#FEF2F2', iconBgDark: '#450A0A', danger: true })}
              style={[
                styles.logoutButton,
                {
            ...
            >
              <Feather name="log-out" size={moderateScale(16)} color={colors.favoriteRed} style={{ marginRight: 6 }} />
              <Text style={[styles.logoutText, { fontSize: moderateScale(13), color: colors.favoriteRed }]}>
                Log Out of Account
              </Text>
            </TouchableOpacity>
            ...
            <View style={[styles.footer, { marginTop: spacing.lg }]}>
              <View style={layout.horizontalView}>
                <Text style={[typography.brandTitle, { fontSize: moderateScale(15), color: colors.textPrimary }]}>Stay</Text>
                <Text style={[typography.brandHighlight, { fontSize: moderateScale(15), color: colors.primary }]}>Finder</Text>
                <View style={[styles.verifiedDot, { backgroundColor: colors.verifiedGreen }]} />
              </View>
              <Text style={[styles.versionText, { fontSize: moderateScale(11), color: colors.textMuted, marginTop: 2 }]}>
